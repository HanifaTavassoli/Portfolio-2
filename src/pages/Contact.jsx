...
function ContactForm({ isDark, toggleTheme }) {
  ...
  return (
    <>
      <Layout isDark={isDark} toggleTheme={toggleTheme}>
        <section
          id="contacts-section"
          className="py-5  bg-gray-200 text-black dark:bg-neutral-800 dark:text-white"
        >
          <div className="custom-container py-20 mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row gap-10 justify-center items-start md:items-center w-full px-4">
              {/* Form Section */}
              <form
                className="form w-full  bg-gray-100/50 dark:bg-neutral-900/50 md:basis-2/3 text-start  shadow-md rounded-lg shadow-sky-500/50 transform transition-transform duration-500 hover:scale-105"
              ...
              <div className="w-full md:basis-1/3 p-8 bg-gray-100/50 dark:bg-neutral-900/50 rounded-lg shadow-md shadow-sky-500/50 transform transition-transform duration-500 hover:scale-105">
